...
export const AW_TEAM_ROWS = [
  { name: "Denial Esports", players: ["Replays", "Attach", "Clayster", "JKap"] },
  { name: "Revenge", players: ["Remy", "Nagafen", "Faccento", "Aqua"] },
  { name: "FaZe Red", players: ["ACHES", "SlasheR", "Parasite", "Enable"] },
  { name: "Prophecy", players: ["Ricky", "MBoZe", "Mochila", "Classic"] },
  { name: "Automatic Reload", players: ["Burns", "Blfire", "Anticity", "Whea7s"] },
  { name: "Mindfreak", players: ["BuZZO", "Shockz", "Fighta", "Denz"] },
  { name: "OpTic Gaming", players: ["NaDeSHoT", "Scump", "FormaL", "Crimsix"] },
  { name: "Team Kaliber", players: ["Sharp", "Goonjar", "Theory", "Loony"] },
  { name: "Envy", players: ["MerK", "NAMELESS", "Saints", "ZooMaa"] },
  { name: "Strictly Business", players: ["pHiZZURP", "John", "Dedo", "Neslo"] },
  { name: "Aware Gaming", players: ["Watson", "JTee", "Joee", "Peatie"] },
  { name: "Orbit eSport", players: ["SinfuL", "TwiZz", "Accuracy", "Lawless"] },
  { name: "FaZe Black", players: ["Censor", "Apathy", "ProoFy", "StuDyy"] },
  { name: "OpTic Nation", players: ["TeePee", "Karma", "KiLLa", "MiRx"] },
  { name: "Below Zero", players: ["GodLike", "Assault", "Wolf", "REPPIN"] },
  { name: "Gamers2", players: ["TojoR", "Lgend", "MethodZ", "JK7"] },
  { name: "NxG.Rapid", players: ["POW3R", "Ko1gaa", "Pibo", "Duke"] },
  { name: "HyperGames", players: ["MAxxie", "AzoX", "Veziok", "TonyJ's"] },
  { name: "fabE.DE", players: ["Bullet", "GunElite", "Kivi", "KraQz"] },
  { name: "Team Exile5.T1", players: ["Damage", "Fate", "Iskatuu", "Chilean"] },
  { name: "Team Menace", players: ["beakd", "Eyedi", "GefKid", "Juunaz"] },
  { name: "3sUP", players: ["CaLiFa", "Strife", "Vert", "Dimi"] },
  { name: "TCM-Gaming", players: ["Moose", "GunShy", "ShAnE", "Jurd"] },
  { name: "Epsilon Esports", players: ["Joshh", "MadCat", "Swanny", "Tommey"] },
  { name: "Vitality.X", players: ["RiskiN", "Getsom", "dyLux", "Oxygen"] },
  { name: "Klar1ty Gaming", players: ["DMK0", "SkittleZ", "Scotland", "SunnyB"] },
  { name: "fabE.AllStars", players: ["RusH", "Torres", "Sempa", "LXT"] },
  { name: "SSOF Gaming", players: ["Le", "H", "Caio", "Carlao"] },
];
